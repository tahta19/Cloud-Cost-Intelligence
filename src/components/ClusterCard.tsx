...
export const ClusterCard: React.FC<ClusterCardProps> = ({ data, index, isVisible }) => {
  ...
  return (
    <motion.article
      ...
      className="group flex-1 p-6 bg-white dark:bg-[#1E1F23] backdrop-blur-[6px] rounded-2xl border border-gray-200 dark:border-[#434654] hover:border-blue-400 dark:hover:border-[#B5C4FF]/50 hover:shadow-lg dark:hover:shadow-2xl hover:shadow-black/10 dark:hover:shadow-black/50 transition-all duration-300 cursor-pointer flex flex-col justify-between min-h-[420px]"
      role="button"
      tabIndex={0}
